...
public class SSCJYMJ_GetRoomInfo<T> extends BaseSendMsg {
    ...
    public static <T> SSCJYMJ_GetRoomInfo make(long roomID, String key, int createSec, PrizeType prizeType,
        ...
        SSCJYMJ_GetRoomInfo ret = new SSCJYMJ_GetRoomInfo();
        ret.roomID = roomID;
        ret.key = key;
