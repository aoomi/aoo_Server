...
public class SSCJYMJ_PosUpdate extends BaseSendMsg {
    // 房间ID
    private long roomID;
    // 玩家位置
    private int pos;
    ...
    public static SSCJYMJ_PosUpdate make(long roomID, int pos, RoomPosInfo posInfo, int custom) {
        SSCJYMJ_PosUpdate ret = new SSCJYMJ_PosUpdate();
