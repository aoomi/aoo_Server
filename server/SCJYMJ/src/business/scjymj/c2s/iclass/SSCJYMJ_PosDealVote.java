...
public class SSCJYMJ_PosDealVote extends BaseSendMsg {
    // 房间ID
    private long roomID;
    // 位置
    private int pos;
    ...
    public static SSCJYMJ_PosDealVote make(long roomID, int pos, boolean agreeDissolve) {
        SSCJYMJ_PosDealVote ret = new SSCJYMJ_PosDealVote();
