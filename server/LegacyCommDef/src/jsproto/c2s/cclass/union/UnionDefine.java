...
public class UnionDefine {
    ...
    /**
     * 联盟 状态 1未批准,2已拒绝,3为已加入,4为已踢出,5已邀请,6邀请被拒,7退出,8关闭联盟踢出
     */
    ...
    public enum UNION_POST_TYPE {
        ...
        /** 新业务语义别名；旧枚举名保留用于线上协议兼容。 */
        public static final UNION_POST_TYPE AllianceOwner = UNION_CREATE;
        public static final UNION_POST_TYPE AllianceManager = UNION_MANAGE;
        public static final UNION_POST_TYPE Ally = UNION_CLUB;
        public static final UNION_POST_TYPE Member = UNION_GENERAL;
    ...
    public enum UNION_CREATE_LIMIT {
         ...
         * 联盟总分
         */
        UNION_TOTAL_SCORE_LIMIT(0, 999_999_999),
        /**
         * 比赛频率
         */
        ...
        public final static boolean checkLimit(UNION_CREATE_LIMIT limit, long value) {
            if (limit.max == -1) {
                return value >= limit.min;
            }
            return value >= limit.min && value <= limit.max;
