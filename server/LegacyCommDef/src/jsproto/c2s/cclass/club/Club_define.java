...
public class Club_define {
    ...
    public enum Club_MINISTER {
        ...
        /** 新业务语义别名；旧枚举名和数值保留用于线上协议兼容。 */
        public static final Club_MINISTER Member = Club_MINISTER_GENERAL;
        public static final Club_MINISTER ClubManager = Club_MINISTER_MGR;
        public static final Club_MINISTER ClubOwner = Club_MINISTER_CREATER;
        public static final Club_MINISTER AllianceManager = Club_MINISTER_UNIONMGR;
        ...
        public String displayName() {
            switch (this) {
                case Club_MINISTER_CREATER:
                    return "圈主";
                case Club_MINISTER_MGR:
                    return "圈管理";
                case Club_MINISTER_UNIONMGR:
                    return "联盟管理";
                default:
                    return "成员";
            }
    ...
    public enum CLUB_PROMOTION_TIME_TYPE {
        ...
        CLUB_PROMOTION_TIME_TYPE(int value) {
            this.value = value;
        }
