    ...
    public static void getSort(List list, boolean asc) {
        ...
        Collections.sort(list, new Comparator() {
            ...
            public int compare(Object o1, Object o2) {
                if (asc) {
                    return Integer.compare(BasePocker.getCardValue((Integer) o1), BasePocker.getCardValue((Integer) o2));
                } else {
                    return Integer.compare(BasePocker.getCardValue((Integer) o2), BasePocker.getCardValue((Integer) o1));
                }
            }
        });
    }
