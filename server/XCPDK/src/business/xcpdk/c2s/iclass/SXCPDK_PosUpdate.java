...
public class SXCPDK_PosUpdate extends BaseSendMsg {
	// 房间ID
	private long roomID;
	// 玩家位置
	private int pos;
	...
	public static SXCPDK_PosUpdate make(long roomID, int pos, RoomPosInfo posInfo, int custom) {
		SXCPDK_PosUpdate ret = new SXCPDK_PosUpdate();
