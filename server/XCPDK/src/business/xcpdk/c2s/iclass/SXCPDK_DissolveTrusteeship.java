...
public class SXCPDK_DissolveTrusteeship extends BaseSendMsg {
    // 房间ID
    private long roomID;
    // 托管玩家
    ...
    public static SXCPDK_DissolveTrusteeship make(long roomID, List<Long> trusteeshipPlayerList, int endSec) {
        SXCPDK_DissolveTrusteeship ret = new SXCPDK_DissolveTrusteeship();
