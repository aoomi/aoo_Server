...
public class SXCPDK_PosDealVote extends BaseSendMsg {
	// 房间ID
	private long roomID;
	// 位置
	private int pos;
	...
	public static SXCPDK_PosDealVote make(long roomID, int pos, boolean agreeDissolve) {
		SXCPDK_PosDealVote ret = new SXCPDK_PosDealVote();
