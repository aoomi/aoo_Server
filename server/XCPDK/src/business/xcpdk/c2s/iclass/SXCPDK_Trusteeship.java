...
public class SXCPDK_Trusteeship extends BaseSendMsg {
	// 房间ID
	private long roomID;
	// 玩家PID
	private long pid;
	...
	public static SXCPDK_Trusteeship make(long roomID, long pid, int pos, boolean trusteeship) {
		SXCPDK_Trusteeship ret = new SXCPDK_Trusteeship();
