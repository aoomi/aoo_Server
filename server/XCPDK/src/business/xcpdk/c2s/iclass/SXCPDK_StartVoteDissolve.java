...
public class SXCPDK_StartVoteDissolve extends BaseSendMsg {
	// 房间ID
	private long roomID;
	// 发起人
	...
	public static SXCPDK_StartVoteDissolve make(long roomID, int createPos, int endSec) {
		SXCPDK_StartVoteDissolve ret = new SXCPDK_StartVoteDissolve();
