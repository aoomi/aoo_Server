...
public class CXCPDKAddDouble extends PlayerHandler{
	...
	public void handle(Player player, WebSocketRequest request, String message) throws WSException, IOException {
    	...
    	if (null == room){
    		request.error(ErrorCode.NotAllow, "CXCPDKAddDouble not find room:"+clientPack.roomID);
    		return;
    	}
    	XCPDKRoomSet set =  (XCPDKRoomSet) room.getCurSet();
    	if(null == set){
    		request.error(ErrorCode.NotAllow, "CXCPDKAddDouble not set room:"+clientPack.roomID);
    		return;
    	}
