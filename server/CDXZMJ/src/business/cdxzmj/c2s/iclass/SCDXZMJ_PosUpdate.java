...
public class SCDXZMJ_PosUpdate extends BaseSendMsg {				
	// 房间ID				
	private long roomID;				
	// 玩家位置				
	private int pos;				
	...
	public static SCDXZMJ_PosUpdate make(long roomID, int pos, RoomPosInfo posInfo, int custom) {				
		SCDXZMJ_PosUpdate ret = new SCDXZMJ_PosUpdate();				
