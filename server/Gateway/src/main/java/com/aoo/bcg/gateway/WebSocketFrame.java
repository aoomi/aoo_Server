...
public record WebSocketFrame(String protocolVersion, String msgId, String kind, String requestId, long seq,
    ...
    public WebSocketFrame {
        ...
        if (msgId == null || !msgId.matches("[a-z][a-z0-9_]*(?:\\.(?:[a-z][a-z0-9_]*|[A-Z]{2}[1-5][0-9]{2}))+") || requestId == null || requestId.isBlank() || requestId.length() > 128 || seq <= 0 || roundNo < 0 || timestamp <= 0) throw new IllegalArgumentException("invalid websocket frame");
