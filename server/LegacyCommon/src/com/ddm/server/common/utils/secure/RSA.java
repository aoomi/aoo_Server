...
public class RSA {
    ...
    public static byte[] decryptData(byte[] encryptedData, PrivateKey privateKey) {
        try {
            ...
            System.getLogger(RSA.class.getName()).log(System.Logger.Level.ERROR, "decryptData failed", e);
            return null;
        }
    }
    ...
    public static byte[] encryptData(byte[] data, PublicKey publicKey) {
        try {
            ...
            System.getLogger(RSA.class.getName()).log(System.Logger.Level.ERROR, "encryptData failed", e);
            System.getLogger("legacy").log(System.Logger.Level.ERROR, "Legacy operation failed", e);
            return null;
        }
    }
