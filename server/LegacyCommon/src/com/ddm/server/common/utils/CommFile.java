...
public class CommFile {
    ...
    public static String bufferedReader(String path) throws IOException {
        ...
        try {
            br = new BufferedReader(new FileReader(file, java.nio.charset.StandardCharsets.UTF_8));
            String line;
    ...
    public static CharBuffer getFileData(String filePath) {
        ...
        try {
            ...
            ((java.nio.Buffer) data).limit(Math.max(count, 0));
        } catch (Exception e) {
            return null;
        } finally {
            if (fin != null) {
    ...
    public static void Write(String path, byte[] content) throws IOException {
        Write(path, new String(content, java.nio.charset.StandardCharsets.UTF_8));
    }
    ...
    public static void Write(String path, String content) throws IOException {
        ...
        try (OutputStreamWriter osw = new OutputStreamWriter(new FileOutputStream(f), java.nio.charset.StandardCharsets.UTF_8)) {
            osw.write(content);
        }
    }
