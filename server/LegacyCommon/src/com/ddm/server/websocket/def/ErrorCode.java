...
public enum ErrorCode {
    ...
    Request_OutcomeUnknown(206), // 请求可能已受理，禁止自动重试并按业务键查询
    Request_DependencyUnavailable(207), // 依赖明确未受理，可稍后重试
    ...
    CLUB_SPORT_POINT_WARN(5133),// 您所在的俱乐部比赛分低于预警值，无法加入比赛，请联系管理
    CLUB_ALIVE_POINT_WARN(5134),// 您所在的俱乐部生存积分过低，无法加入比赛，请联系管理
    CLUB_PERSONAL_ALIVE_POINT_WARN(5136),// 您所在的推广员队伍或上级队伍比赛分低于生存积分，无法加入比赛，请联系管理，无法加入比赛，请联系管理

    MUST_BIND_PHONE(5137),// 请先绑定手机
    ...
    CLUB_EXIST_CREATE(6007),//俱乐部存在圈主
    CLUB_NOT_EXIST(6008),//俱乐部不存在
    CLUB_NOT_EXIST_MEMBER_INFO(6009),//俱乐部不存在成员信息
    CLUB_NOT_EXIST_CREATE(6010),//俱乐部圈主不存在

    CLUB_PARTNER_UPPER_LIMIT(6011),//俱乐部合伙人上限
    CLUB_PARTNER_EXIST(6012),//该玩家已绑定合伙人
    CLUB_PARTNER_CREATE(6013),//俱乐部合伙人和圈主不允许变更。
    CLUB_NOT_PARTNER(6014),//不是俱乐部合伙人。。
    CLUB_NOT_CREATE(6015),//不是俱乐部创造者。
    CLUB_INVITATION_ERROR(6016),//俱乐部-邀请失败
    CLUB_BAN_GAME(6017),//成员被禁止游戏
    CLUB_ENTER_NOT_CLUBMEMBER(6018), //通过房间号进入房间时提示：不是俱乐部成员，返回俱乐部Key.
    CLUB_EXIST_JIARU(6019), //已加入俱乐部
    CLUB_PLAYER_WEIPIZHUN(6020),// 等待俱乐部管理员批准中
    CLUB_MEMBER_UPPER_LIMIT(6021),// 俱乐部人数已满
    CLUB_PLAYER_UPPER_LIMIT(6022),// 自己加入的俱乐部数达到上限
    CLUB_PLAYER_ADD(6028),    // 俱乐部人员添加失败
    CLUB_EXIST_UNION(6032),         /// 俱乐部已经加入赛事
    CLUB_QUIT_UNION(6033),         /// 俱乐部已经退出赛事
    CLUB_MEMBER_SAME_POST_TYPE(6034),//俱乐部成员相同权利
    CLUB_NOT_JOIN_UNION(6035),//俱乐部没加入赛事
    CLUB_UNION_CREATE(6036),//您的俱乐部为联盟盟主，当前不可解散
    CLUB_NAME_ERROR(6037),// 俱乐部名称错误
    CLUB_NAME_EXIST(6038),// 俱乐部名称存在重复
    ...
    CLUB_EXIST_PROMOTION_TICHU_ERROR(6047),//删除推广员后，该玩家将被踢出俱乐部
    CLUB_UP_LEVEL_MEMBER_NOT_EXIST(6048),// 上级推广员不存在
    CLUB_MEMBER_ROOM_ERROR(6049),// 成员在游戏中无法踢出俱乐部
    ...
    CLUB_MEMBER_CLUB_PROMOTION_CHANGE_IS_EXIT(6066),//整个俱乐部有人正在修改归属，请稍后再试

    CLUB_MEMBER_JOIN_TIME_LIMIT(6067),//退出加入同一个俱乐部添加10分钟时间限制
    CLUB_PROMOTION_CHANGE_NOT_CLUBCREATE(6068),//不是圈主不能移动到圈主名下

    UNION_NOT_EXIST(6100),  // 赛事不存在
    UNION_NOT_MANAGE(6101),  // 不是联盟管理或盟主
    ...
    UNION_JOIN_CLUB_SAME_UNION(6145),// 允许俱乐部添加同赛事玩家
