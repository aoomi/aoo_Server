...
/** Persists authoritative ZYPK events and recovery snapshots as one ordered boundary. */
public final class ZYPKPersistenceService {
    public static final int GAME_ID = 62;
    public static final String PLAY_VERSION = "zypk-v1.0.0";
    public static final String COMPONENT_VERSION = "zypk-table-v1";

    private final RoomEventJournal events;
    private final RoomSnapshotStore snapshots;
    private final Clock clock;

    public ZYPKPersistenceService(RoomEventJournal events, RoomSnapshotStore snapshots, Clock clock) {
        this.events = java.util.Objects.requireNonNull(events);
        this.snapshots = java.util.Objects.requireNonNull(snapshots);
        this.clock = java.util.Objects.requireNonNull(clock);
    }

    public void persist(ZYPKTable table, int roundNo, long sequence, long fencingToken,
