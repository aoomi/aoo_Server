...
final class GameProviderServiceLoaderTest {
    ...
    @Test void catalogExpandsLongAndWordRowsThroughFamilyProviders() {
        ...
        assertEquals(532, GameCatalogLoader.registerMissing(registry));
