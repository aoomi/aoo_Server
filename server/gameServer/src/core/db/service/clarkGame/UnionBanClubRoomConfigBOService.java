...
import core.db.entity.clarkGame.UnionBanClubRoomConfigBO;
...
public class UnionBanClubRoomConfigBOService implements BaseService<UnionBanClubRoomConfigBO> {
    private BaseClarkGameDao<UnionBanClubRoomConfigBO> clubBanRoomConfigBODao = new BaseClarkGameDao<>(UnionBanClubRoomConfigBO.class);
    ...
    public void execBatchDb(List<UnionBanClubRoomConfigBO> unionBanRoomConfigBOList) {
        //新new对象做操作
        List<UnionBanClubRoomConfigBO> list = Lists.newArrayList(unionBanRoomConfigBOList);
        if (CollectionUtils.isNotEmpty(list)) {
            ...
            for (int i = 0; i < list.size(); i++) {
                UnionBanClubRoomConfigBO entity = list.get(i);
