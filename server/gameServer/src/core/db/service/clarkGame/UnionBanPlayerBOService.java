...
public class UnionBanPlayerBOService implements BaseService<UnionBanPlayerBO> {
    private BaseClarkGameDao<UnionBanPlayerBO> unionBanPlayerBODao = new BaseClarkGameDao<>(UnionBanPlayerBO.class);
    @Override
