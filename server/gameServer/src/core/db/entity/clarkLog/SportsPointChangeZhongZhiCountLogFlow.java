...
public class SportsPointChangeZhongZhiCountLogFlow extends BaseClarkLogEntity<SportsPointChangeZhongZhiCountLogFlow> {
    ...
    public SportsPointChangeZhongZhiCountLogFlow(long pid, long clubId, long unionId, int reason, double num, double curRemainder, double preValue, int type, int gameId, int classificationRegionId, long roomId) {
        this.pid = pid;
        this.clubId = clubId;
    ...
    public String getInsertSql() {
        return "INSERT INTO SportsPointChangeZhongZhiCountLog"
                + "(`serverId`, `timestamp`, `dateTime`, `pid`, `clubId`,`unionId`, `reason`, `num`, `curRemainder`, `preValue`, `type`,`gameId`,`classificationRegionId`, `roomId`)"
                + "values(?, ?, ?, ?, ?, ?,?, ?, ?, ?, ?, ?,?,?)";
    }
