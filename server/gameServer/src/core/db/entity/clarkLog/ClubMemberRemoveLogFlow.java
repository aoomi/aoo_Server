...
public class ClubMemberRemoveLogFlow extends BaseClarkLogEntity<ClubMemberRemoveLogFlow> {
    ...
    @DataBaseField(type = "int(11)", fieldname = "isminister", comment = "职务 0普通会员 1管理 2圈主")
    private int isminister = 0; // 职务 0普通会员 1管理 2圈主
    ...
    public static String getCreateTableSQL() {
        String sql = "CREATE TABLE IF NOT EXISTS `ClubMemberRemoveLog` ("
                ...
                + "`isminister` int(11) NOT NULL DEFAULT '0' COMMENT '职务 0普通会员 1管理 2圈主',"
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='俱乐部成员移除日志表' DEFAULT CHARSET=utf8";
        return sql;
    }
