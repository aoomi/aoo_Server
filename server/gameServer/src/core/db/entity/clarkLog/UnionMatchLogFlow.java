...
public class UnionMatchLogFlow extends BaseClarkLogEntity<UnionMatchLogFlow> {
    ...
    private long pid;
    @DataBaseField(type = "int(6)", fieldname = "clubSign", comment = "俱乐部Id")
    private int clubSign = 0;
    @DataBaseField(type = "varchar(25)", fieldname = "clubName", comment = "所属俱乐部")
    ...
    public static String getCreateTableSQL() {
        String sql = "CREATE TABLE IF NOT EXISTS `UnionMatchLog` ("
                ...
                + "`clubSign` int(6) NOT NULL DEFAULT '0' COMMENT '俱乐部Id',"
                + "`clubName` varchar(25) NOT NULL DEFAULT '' COMMENT '所属俱乐部',"
