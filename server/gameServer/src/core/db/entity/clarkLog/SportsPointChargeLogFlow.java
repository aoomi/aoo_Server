...
public class SportsPointChargeLogFlow extends BaseClarkLogEntity<SportsPointChargeLogFlow> {
    ...
    public SportsPointChargeLogFlow(long pid, long clubId, long unionId, int reason, double num, double curRemainder, double preValue, int type, int gameId, int classificationRegionId, long roomId) {
        this.pid = pid;
        this.clubId = clubId;
