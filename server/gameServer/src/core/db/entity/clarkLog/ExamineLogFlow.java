...
public class ExamineLogFlow extends BaseClarkLogEntity<ExamineLogFlow> {
    ...
    private long pid;
    @DataBaseField(type = "bigint(20)", fieldname = "toClubMemberId", comment = "玩家俱乐部身份id")
    private long toClubMemberId;
    @DataBaseField(type = "bigint(20)", fieldname = "doClubMemberId", comment = "执行审核玩家俱乐部身份id")
    ...
    public static String getCreateTableSQL() {
        String sql = "CREATE TABLE IF NOT EXISTS `ExamineLog` ("
                ...
                + "`toClubMemberId` bigint(20) NOT NULL DEFAULT '0' COMMENT '玩家俱乐部身份id',"
                + "`doClubMemberId` bigint(20) NOT NULL DEFAULT '0' COMMENT '执行审核玩家俱乐部身份id',"
