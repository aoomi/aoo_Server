...
public class FamilyBO extends BaseEntity<FamilyBO> {
    ...
    @DataBaseField(type = "int(11)", fieldname = "clubLevel", comment = "给俱乐部代理分成比")
    private int clubLevel;
    @DataBaseField(type = "bigint(20)", fieldname = "clubTotalRMB", comment = "俱乐部累计充值")
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `family` ("
                ...
                + "`clubLevel` int(11) NOT NULL DEFAULT '0' COMMENT '给俱乐部代理分成比',"
                + "`clubTotalRMB` bigint(20) NOT NULL DEFAULT '0' COMMENT '俱乐部累计充值',"
