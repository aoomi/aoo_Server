 ...
 *
 */
@TableName(value = "unionBanPlayer")
@Data
@NoArgsConstructor
public class UnionBanPlayerBO extends BaseEntity<UnionBanPlayerBO> {
    ...
    public UnionBanPlayerBO(long unionId, String name, String headImageUrl, long pid, int createTime) {
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `unionBanPlayer` ("
                ...
                + "KEY `name` (`name`),"
                + "KEY `pid` (`pid`)"
                + ") COMMENT='赛事禁止玩家数据表'  DEFAULT CHARSET=utf8 AUTO_INCREMENT=" + (Constant.InitialID + 1);
        return sql;
    }


    public String getInsertSql() {
        return "INSERT ignore INTO unionBanPlayer"
