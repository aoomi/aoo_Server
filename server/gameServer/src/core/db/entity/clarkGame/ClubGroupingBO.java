...
public class ClubGroupingBO extends BaseEntity<ClubGroupingBO> {
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `ClubGrouping` ("
                ...
                + ") COMMENT='俱乐部分组'  DEFAULT CHARSET=utf8 AUTO_INCREMENT=" + (ServerConfig.getInitialID() + 1);
        return sql;
    }
    ...
    public List<Long> getGroupingToList() {
        ...
        if (this.groupingList.size() <= 0) {
            this.groupingList = new Gson().fromJson(this.grouping, new TypeToken<List<Long>>() {
            }.getType());
        }
        return this.groupingList;
