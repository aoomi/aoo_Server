...
/** One account-wide room-card balance, owned only by the login account id. */
...
public class PlayerWalletBO extends BaseEntity<PlayerWalletBO> {
    ...
    private long id;
    @DataBaseField(type = "bigint(20)", fieldname = "accountID", comment = "login account id")
    ...
    public PlayerWalletBO(long accountID) { this.accountID = accountID; }
    ...
    public static String getSql_TableCreate() {
        return "CREATE TABLE IF NOT EXISTS `playerWallet` ("
                ...
                + "PRIMARY KEY (`id`), UNIQUE KEY `uk_player_wallet_account` (`accountID`)"
