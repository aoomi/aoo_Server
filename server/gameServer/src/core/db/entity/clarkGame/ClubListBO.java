...
public class ClubListBO extends BaseEntity<ClubListBO> {
    ...
    @DataBaseField(type = "bigint(20)", fieldname = "ownerID", comment = "俱乐部圈主ID")
    private long ownerID;
    @DataBaseField(type = "text", fieldname = "clubConfig", comment = "俱乐部设置")
    private String clubConfig = "";// 俱乐部设置
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `dbClubList` ("
                ...
                + "`ownerID` bigint(20) NOT NULL DEFAULT '0' COMMENT '俱乐部圈主ID',"
                + "`clubConfig` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL  COMMENT '俱乐部设置',"
                ...
                + ") COMMENT='俱乐部表'  DEFAULT CHARSET=utf8 AUTO_INCREMENT=" + (Constant.InitialID + 1);
        return sql;
    }
