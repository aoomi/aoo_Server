...
public class UnionMemberBO extends BaseEntity<UnionMemberBO> {
    ...
    private long clubId;
    @DataBaseField(type = "bigint(20)", fieldname = "clubOwnerId", comment = "俱乐部圈主ID")
    ...
    @DataBaseField(type = "bigint(20)", fieldname = "clubMemberId", comment = "俱乐部成员Id")
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `bigUnionMember` ("
                ...
                + "`clubOwnerId` bigint(20) NOT NULL DEFAULT '0' COMMENT '俱乐部圈主ID',"
                ...
                + "`clubMemberId` bigint(20) NOT NULL DEFAULT 0  COMMENT '俱乐部成员Id',"
