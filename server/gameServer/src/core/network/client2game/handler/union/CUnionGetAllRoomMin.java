...
//        }
        ...
        player.pushProto(SUnion_GetAllRoomMin.make(req.getClubId(), req.getUnionId(), UnionMgr.getInstance().onUnionGetAllRoomShortOne(req.getUnionId(), clubMember.getClubMemberBO().getUnionNotGameList(), clubMember.getClubMemberBO().getIsHideStartRoom(), req.getPageNum(), union.getUnionBO().getSort(), req.getGameType())));
