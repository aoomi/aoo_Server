...
//        }
        ...
        request.response(SUnion_GetAllRoomData.make(UnionMgr.getInstance().onUnionGetAllRoomShortTwo(req.getUnionId(), clubMember.getClubMemberBO().getUnionNotGameList(), clubMember.getClubMemberBO().getIsHideStartRoom(), req.getPageNum(), union.getUnionBO().getSort(), req.getRoomKey(), req.getGameType())));
