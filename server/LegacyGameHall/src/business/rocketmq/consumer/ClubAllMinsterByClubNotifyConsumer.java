...
public class ClubAllMinsterByClubNotifyConsumer implements MqConsumerHandler {
    ...
    public void action(Object body) {
        ...
        CommLogD.info("俱乐部管理员消息通知[{}]", JsonUtil.toJson(mqClubRoomResultBo));
        if (mqClubRoomResultBo.getClubID() == null) return;
        ShareClubMemberMgr.getInstance().getAllOneClubMember(mqClubRoomResultBo.getClubID()).values().stream()
                // 筛选俱乐部ID和成员状态
