...
class NiuNiuHandEvaluatorTest {
  ...
  @Test void appliesThreeXqpRateModes() {
    ...
    var passion = new NiuNiuRules(10,8,2,NiuNiuRules.Mode.PASSION,4,10,NiuNiuRules.StandPolicy.EVERYONE_MAY_STAND,true);
    var crazy = new NiuNiuRules(10,8,2,NiuNiuRules.Mode.CRAZY,4,10,NiuNiuRules.StandPolicy.EVERYONE_MAY_STAND,true);
