...
n=File.read(File.join(client,'assets/Common/Code/Runtime/CompatibilityApp/network/ProtocolClient.ts'))
if (m=n.match(/from\s+['"]([^'"]*network\/ProtocolClient)['"]/))
  target=File.expand_path("#{m[1]}.ts",File.dirname(File.join(client,'assets/Common/Code/Runtime/CompatibilityApp/network/ProtocolClient.ts')))
